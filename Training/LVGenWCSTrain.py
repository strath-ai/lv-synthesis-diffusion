...
def load_data(train_path: str, test_path: str):
    ...
    # Calculate min, mean, and max along dimension 1
    ...
    # Repeat these values 144 times along the second dimension
    ...
    # Add these as new channels to your existing data
    ...
    train_channel_0 = train_scaled[:, :, 1:2]
    test_channel_0 = test_scaled[:, :, 1:2]
    # Calculate min, mean, and max along dimension 1
    min_train = np.amin(train_channel_0, axis=1, keepdims=True)
    mean_train = np.mean(train_channel_0, axis=1, keepdims=True)
    max_train = np.amax(train_channel_0, axis=1, keepdims=True)
...
def main():
    ...
    (
        ...
        diffusion_hyperparams,
        model_config,
    ) = load_config("../configs/LVGenWCS.json")
