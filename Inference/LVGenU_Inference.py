...
def load_config():
    with open(os.path.join(BASE_DIR, "configs", "LVGenU.json"), "r") as f:
        config = json.load(f)
...
def main():
    ...
    parser.add_argument("--num_samples", type=int, default=779)
    parser.add_argument("--output_directory", type=str, default=os.path.join(BASE_DIR, "Inference", "results", "LVGenU"))
    parser.add_argument("--ckpt_path", type=str, default=os.path.join(BASE_DIR, "Training", "results", "LVGenU"))
